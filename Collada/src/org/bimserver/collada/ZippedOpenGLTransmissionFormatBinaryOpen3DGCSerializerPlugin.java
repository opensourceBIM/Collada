...
public class ZippedOpenGLTransmissionFormatBinaryOpen3DGCSerializerPlugin extends AbstractSerializerPlugin {
	...
	public String getDescription() {
		return "Zipped OpenGL Transmission Format (glTF) with binary Open3DGC compression.";
	}

	@Override
	public String getDefaultName() {
		return "glTF with binary Open3DGC compression as ZIP";
	}
