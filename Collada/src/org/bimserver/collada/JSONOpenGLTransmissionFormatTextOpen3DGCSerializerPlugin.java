...
public class JSONOpenGLTransmissionFormatTextOpen3DGCSerializerPlugin extends AbstractSerializerPlugin {
	...
	public String getDescription() {
		return "JSON data streams (base64) wrapper for OpenGL Transmission Format (glTF) with text-based Open3DGC compression.";
	}
